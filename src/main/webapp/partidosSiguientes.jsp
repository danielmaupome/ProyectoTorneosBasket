...
<%
    ArrayList<Partido> listaPartidos = new MbdPartidos().obtenerPartidosSiguientes();
    Date fecha = new MbdPartidos().obtenerFechaPartidoSiguiente();
            ...
            <div class="row">
                ...
                <div class="col-sm">
                    ...
                    <table class="table">
                        <thead>
                            <tr align="center">
                                <th scope="col" colspan="4">Siguientes partidos: <%=formatoFecha.format(fecha)%></th>
                            </tr>
                        </thead>
                        <tbody>
